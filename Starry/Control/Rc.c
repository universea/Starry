...
*返 回 值: 无
**********************************************************************************************************/
void RcDataUpdate(void)
{
    //获取摇杆数据
		rcData.roll = getDutyFromPwmIn(0);
		rcData.pitch = getDutyFromPwmIn(1);
		rcData.throttle = getDutyFromPwmIn(2);
		rcData.yaw = getDutyFromPwmIn(3);
		rcData.aux1 = getDutyFromPwmIn(4);
		rcData.aux2 = getDutyFromPwmIn(5);
		rcData.aux3 = getDutyFromPwmIn(6);
		rcData.aux4 = getDutyFromPwmIn(7);
    //更新摇杆控制命令
    RcCommandUpdate();
