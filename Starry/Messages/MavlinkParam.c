...
void MavParamSetValue(uint16_t num, float value)
{
    ...
    case MC_ROLLRATE_P:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_ROLLRATE_I:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KI] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_ROLLRATE_D:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KD] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_PITCHRATE_P:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_PITCHRATE_I:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KI] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_PITCHRATE_D:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KD] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_YAWRATE_P:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_YAW][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_YAWRATE_I:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_YAW][KI] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_YAWRATE_D:
        value *= 100;
				myParameters.set.PidAngularVelocityLoop[EULER_YAW][KD] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_ROLL_P:
        value *= 100;
				myParameters.set.PidAngleLoop[EULER_ROLL][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_PITCH_P:
        value *= 100;
				myParameters.set.PidAngleLoop[EULER_PITCH][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MC_YAW_P:
        value *= 100;
				myParameters.set.PidAngleLoop[EULER_YAW][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_XY_VEL_P:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KP] = value;
				myParameters.set.PidPositionVelocityLoop[EULER_PITCH][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_XY_VEL_I:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KI] = value;
				myParameters.set.PidPositionVelocityLoop[EULER_PITCH][KI] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_XY_VEL_D:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KD] = value;
				myParameters.set.PidPositionVelocityLoop[EULER_PITCH][KD] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_Z_VEL_P:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_YAW][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_Z_VEL_I:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_YAW][KI] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_Z_VEL_D:
        value *= 100;
				myParameters.set.PidPositionVelocityLoop[EULER_YAW][KD] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_XY_P:
        value *= 100;
				myParameters.set.PidPositionLoop[EULER_ROLL][KP] = value;
				myParameters.set.PidPositionLoop[EULER_PITCH][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
    ...
    case MPC_Z_P:
        value *= 100;
				myParameters.set.PidPositionLoop[EULER_YAW][KP] = value;
				ParamUpdateData(1);
        PIDReadFromFlash();
        break;
...
void MavParamSetDefault(void)
{
    ...
    mavParam[CAL_GYRO0_ID] = 125;
		mavParam[CAL_GYRO0_XOFF] = myParameters.set.GyroOffset[X];
		mavParam[CAL_GYRO0_YOFF] = myParameters.set.GyroOffset[Y];
		mavParam[CAL_GYRO0_ZOFF] = myParameters.set.GyroOffset[Z];
		mavParam[CAL_GYRO0_XSCALE] = myParameters.set.GyroScale[X];
		mavParam[CAL_GYRO0_YSCALE] = myParameters.set.GyroScale[Y];
		mavParam[CAL_GYRO0_ZSCALE] = myParameters.set.GyroScale[Z];
    ...
    mavParam[CAL_MAG2_ROT] = 0;
		mavParam[CAL_MAG0_XOFF] = myParameters.set.MagOffset[X];
		mavParam[CAL_MAG0_YOFF] = myParameters.set.MagOffset[Y];
		mavParam[CAL_MAG0_ZOFF] = myParameters.set.MagOffset[Z];
		mavParam[CAL_MAG0_XSCALE] = myParameters.set.MagScale[X];
		mavParam[CAL_MAG0_YSCALE] = myParameters.set.MagScale[Y];
		mavParam[CAL_MAG0_ZSCALE] = myParameters.set.MagScale[Z];
    mavParam[CAL_ACC0_ID] = 120;
		mavParam[CAL_ACC0_XOFF] = myParameters.set.AccelOffset[X];
		mavParam[CAL_ACC0_YOFF] = myParameters.set.AccelOffset[Y];
		mavParam[CAL_ACC0_ZOFF] = myParameters.set.AccelOffset[Z];
		mavParam[CAL_ACC0_XSCALE] = myParameters.set.AccelScale[X];
		mavParam[CAL_ACC0_YSCALE] = myParameters.set.AccelScale[Y];
		mavParam[CAL_ACC0_ZSCALE] = myParameters.set.AccelScale[Z];
    ...
    mavParam[SENS_FLOW_ROT] = 0;
		mavParam[SENS_BOARD_X_OFF] = myParameters.set.ImuLevel[X];
		mavParam[SENS_BOARD_Y_OFF] = myParameters.set.ImuLevel[Y];
		mavParam[SENS_BOARD_Z_OFF] = myParameters.set.ImuLevel[Z];
    ...
    mavParam[GF_FENCE_SW] = 1;
		...
		mavParam[MC_ROLLRATE_P] = myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KP];
		mavParam[MC_ROLLRATE_I] = myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KI];
		mavParam[MC_ROLLRATE_D] = myParameters.set.PidAngularVelocityLoop[EULER_ROLL][KD];
		mavParam[MC_PITCHRATE_P] = myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KP];
		mavParam[MC_PITCHRATE_I] = myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KI];
		mavParam[MC_PITCHRATE_D] = myParameters.set.PidAngularVelocityLoop[EULER_PITCH][KD];
		mavParam[MC_YAWRATE_P] = myParameters.set.PidAngularVelocityLoop[EULER_YAW][KP];
		mavParam[MC_YAWRATE_I] = myParameters.set.PidAngularVelocityLoop[EULER_YAW][KI];
		mavParam[MC_YAWRATE_D] = myParameters.set.PidAngularVelocityLoop[EULER_YAW][KD];
		mavParam[MC_ROLL_P] = myParameters.set.PidAngleLoop[EULER_ROLL][KP];
		mavParam[MC_PITCH_P] = myParameters.set.PidAngleLoop[EULER_PITCH][KP];
		mavParam[MC_YAW_P] = myParameters.set.PidAngleLoop[EULER_YAW][KP];
    ...
    mavParam[MPC_MANTHR_MAX] = 0.9;
		...
		mavParam[MPC_XY_VEL_P] = myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KP];
		mavParam[MPC_XY_VEL_I] = myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KI];
		mavParam[MPC_XY_VEL_D] = myParameters.set.PidPositionVelocityLoop[EULER_ROLL][KD];
		mavParam[MPC_Z_VEL_P] = myParameters.set.PidPositionVelocityLoop[EULER_YAW][KP];
		mavParam[MPC_Z_VEL_I] = myParameters.set.PidPositionVelocityLoop[EULER_YAW][KI];
		mavParam[MPC_Z_VEL_D] = myParameters.set.PidPositionVelocityLoop[EULER_YAW][KD];
		mavParam[MPC_XY_P] = myParameters.set.PidPositionLoop[EULER_ROLL][KP];
		mavParam[MPC_Z_P] = myParameters.set.PidPositionLoop[EULER_YAW][KP];
