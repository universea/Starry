...
*返 回 值: 无
**********************************************************************************************************/
void startFlightControlTask(void const * argument)
{
...
{
		osThreadDef(flightControl, startFlightControlTask, FLIGHTCONTROL_TASK_PRIORITY, 0, FLIGHTCONTROL_TASK_STACK);
		flightControlTask = osThreadCreate(osThread(flightControl), NULL);
}
