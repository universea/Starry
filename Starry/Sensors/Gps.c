...
static void GpsCalcPositionChanged(Vector3ForFloat* deltaDis, double lat1, double lon1, double lat2, double lon2);
...
{
    ubloxStruct gpsRaw = ubloxGetData();
