...
static void MagDetectCheck(Vector3ForFloat magRaw);
...
{
		mag.cali.offset.x = myParameters.set.MagOffset[X];
		mag.cali.offset.y = myParameters.set.MagOffset[Y];
		mag.cali.offset.z = myParameters.set.MagOffset[Z];
		mag.cali.scale.x = myParameters.set.MagScale[X];
		mag.cali.scale.y = myParameters.set.MagScale[Y];
		mag.cali.scale.z = myParameters.set.MagScale[Z];
		mag.earthMag = myParameters.set.MagEarthMag;
        ...
        else
        {
            ...
            if(mag.cali.step == 2 && abs(cali_rotate_angle ) > 360)
            {
                ...
                if(mag.cali.success)
                {
                    ...
                    //保存校准参数
										myParameters.set.MagOffset[X] = mag.cali.offset.x;
										myParameters.set.MagOffset[Y] = mag.cali.offset.y;
										myParameters.set.MagOffset[Z] = mag.cali.offset.z;
										myParameters.set.MagScale[X] = mag.cali.scale.x;
										myParameters.set.MagScale[Y] = mag.cali.scale.y;
										myParameters.set.MagScale[Z] = mag.cali.scale.z;
										myParameters.set.MagEarthMag = mag.earthMag;
...
{
    static uint32_t cnt;
    static Vector3ForFloat lastMagRaw;
