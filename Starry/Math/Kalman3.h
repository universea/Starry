...
typedef struct {
    //状态矩阵
    Vector3ForFloat state;
    //滑动窗口大小
    int16_t slidWindowSize;
    //状态滑动窗口
    Vector3ForFloat* statusSlidWindow;
    //观测信号相位补偿值
    Vector3ForInt16 fuseDelay;
    //残差矩阵
    Vector3ForFloat residual;
    //状态转移矩阵
    float f[9];
    //状态转移矩阵的转置
    float f_t[9];
...
void KalmanUpdate(Kalman_t* kalman, Vector3ForFloat input, Vector3ForFloat observe, bool flag);
