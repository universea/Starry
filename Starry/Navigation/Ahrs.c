...
static void AttitudeEstimateUpdate(Vector3ForFloat* angle, Vector3ForFloat gyro, Vector3ForFloat acc, Vector3ForFloat mag, float deltaT);
static void KalmanRollPitchInit(void);
static void KalmanYawInit(void);
static void TransAccToEarthFrame(Vector3ForFloat angle, Vector3ForFloat acc, Vector3ForFloat* accEf, Vector3ForFloat* accEfLpf, Vector3ForFloat* accBfOffset);
static Vector3ForFloat AccSportCompensate(Vector3ForFloat acc, Vector3ForFloat sportAccEf, Vector3ForFloat angle, Vector3ForFloat accBfOffset);
static void GyroEfUpdate(Vector3ForFloat gyro, Vector3ForFloat angle, Vector3ForFloat* gyroEf);
static void CentripetalAccUpdate(Vector3ForFloat* centripetalAcc, Vector3ForFloat velocity, float gyroYawEf);
...
*返 回 值: 对准完成状态
**********************************************************************************************************/
int8_t AttitudeInitAlignment(Kalman_t* rollPitch, Kalman_t* yaw, Vector3ForFloat acc, Vector3ForFloat mag)
{
    static int16_t alignCnt = 200;
    static Vector3ForFloat accSum, magSum;
...
static void AttitudeEstimateUpdate(Vector3ForFloat* angle, Vector3ForFloat gyro, Vector3ForFloat acc, Vector3ForFloat mag, float deltaT)
{
    Vector3ForFloat deltaAngle;
    static Vector3ForFloat gError;
	  static Vector3ForFloat gErrorIntRate = {0.2f, 0.2f, 0.05f};
    static Vector3ForFloat gyro_bias = {0, 0, 0};    //陀螺仪零偏
    static Vector3ForFloat input = {0, 0, 0};
    float dcMat[9];
    Vector3ForFloat mVectorEf;
...
static void TransAccToEarthFrame(Vector3ForFloat angle, Vector3ForFloat acc, Vector3ForFloat* accEf, Vector3ForFloat* accEfLpf, Vector3ForFloat* accBfOffset)
{
    ...
    static Vector3ForFloat accAngle;   //用于计算初始零偏
    Vector3ForFloat gravityBf;
