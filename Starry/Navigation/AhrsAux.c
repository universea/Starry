...
*返 回 值: 对准完成状态
**********************************************************************************************************/
int8_t AttitudeAuxInitAlignment(Kalman_t* kalman, float q[4],Vector3ForFloat acc, Vector3ForFloat mag)
{
...
{
    static Vector3ForFloat vectorG;
    static Vector3ForFloat gError, mError;
    static Vector3ForFloat gyro_bias;
    static Vector3ForFloat hMag;
